...
(function(c){var b=c.th.Klass.extend({init:function(a){this.active=!1;this.cycles=0;this.loopFunction=null;this.set(a);this.findCanvas()},findCanvas:function(){var a=document.querySelector("canvas"),e=a.getContext("2d");a.width=a.clientWidth;a.height=a.clientHeight;c.th.ctx=e;c.th.canvas=a},start:function(){this.active=!0;this.loop()},stop:function(){this.active=!1},clear:function(){th.ctx.clearRect(0,0,th.canvas.width,th.canvas.height)},loop:function(){this.active&&(this.cycles+=1,this.clear(),this.loopFunction&&
this.loopFunction(),th.helpers.requestAnimationFrame(this.loop.bind(this)))}});c.th.Game=b})(this);
